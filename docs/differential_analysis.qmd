...
A histogram of Spearman correlations are shown in @fig-multi-assay-correlations.

```{r}
#| label: fig-multi-assay-correlations
#| fig-cap: Metabolite - metabolite Spearman correlations for those metabolites measured in multiple measurement or assay types. 
metabolites_multi_assay_correlations |>
	ggplot(aes(x = cor)) +
