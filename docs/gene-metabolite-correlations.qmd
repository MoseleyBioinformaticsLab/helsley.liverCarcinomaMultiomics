...
So where are the named metabolites in the correlation histogram?

```{r}
#| label: named-metabolite-locs
metabolites_names = metabolites_significant |>
	dplyr::transmute(feature_id = feature_id,
									 metabolite_id = dplyr::case_when(
