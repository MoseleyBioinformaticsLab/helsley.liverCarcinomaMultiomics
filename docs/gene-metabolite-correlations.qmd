...
* Enriched lipid annotations (see @tbl-metabolite-binomial-lipids) include ceramides, phosphatidylserines, lipids with a total carbon count of 18 and 34, zero unsaturations, and triglycerides with a single unsaturation.
...
* Outputs provided:
  ...
  * Differential results for transcriptomics and metabolomics as two sheets in an Excel file.
  * Full set of transcript to metabolite correlations in an Excel file.
