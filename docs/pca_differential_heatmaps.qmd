...
tar_load(c(
  ...
  rna_qcqa,
  rna_pca_heatmap_small,
  bioamines_pca_heatmap_small,
  lipidomics_pca_heatmap_small,
  pm_pca_heatmap_small
))
```
...
rna_pca_heatmap_small$heatmap = draw(rna_pca_heatmap_small$heatmap) |>
  grid.grabExpr()
patchwork::wrap_plots(
  A = rna_pca_heatmap_small$pca,
  B = rna_pca_heatmap_small$volcano,
  C = rna_pca_heatmap_small$heatmap,
  design = layout
)
```
...
lipidomics_pca_heatmap_small$heatmap = draw(
  lipidomics_pca_heatmap_small$heatmap
) |>
  grid.grabExpr()

patchwork::wrap_plots(
  A = lipidomics_pca_heatmap_small$pca,
  B = lipidomics_pca_heatmap_small$volcano,
  C = lipidomics_pca_heatmap_small$heatmap,
  design = layout
)
```
...
bioamines_pca_heatmap_small$heatmap = draw(
  bioamines_pca_heatmap_small$heatmap
) |>
  grid.grabExpr()

patchwork::wrap_plots(
  A = bioamines_pca_heatmap_small$pca,
  B = bioamines_pca_heatmap_small$volcano,
  C = bioamines_pca_heatmap_small$heatmap,
  design = layout
)
```
...
pm_pca_heatmap_small$heatmap = draw(pm_pca_heatmap_small$heatmap) |>
  grid.grabExpr()

patchwork::wrap_plots(
  A = pm_pca_heatmap_small$pca,
  B = pm_pca_heatmap_small$volcano,
  C = pm_pca_heatmap_small$heatmap,
  design = layout
)
```
